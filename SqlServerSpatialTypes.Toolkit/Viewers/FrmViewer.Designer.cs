namespace SqlServerSpatialTypes.Toolkit.Viewers
{
	partial class FrmViewer
	{
		...
		private void InitializeComponent()
		{
			...
			this.spatialViewerControl1 = new SqlServerSpatialTypes.Toolkit.Viewers.SpatialViewerControl();
			this.SuspendLayout();
			// 
			// elementHost1
			// 
			...
			this.Name = "FrmViewer";
			this.Text = "Sql Server Spatial Types Toolkit";
		...
		private SpatialViewerControl spatialViewerControl1;
	}
}