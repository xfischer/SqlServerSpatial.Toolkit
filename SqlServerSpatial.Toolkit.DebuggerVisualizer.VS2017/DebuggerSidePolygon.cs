...
namespace NetTopologySuite.Diagnostics.Visualizer
{
    ...
    {
        protected override NetTopologySuite.Geometries.Geometry GetObject(IVisualizerObjectProvider objectProvider)
        {
            return (NetTopologySuite.Geometries.Geometry)objectProvider.GetObject();
        }
    }

    public abstract class DialogDebuggerVisualizerBase<T> : DialogDebuggerVisualizer where T : IGeometry
    {

        protected abstract T GetObject(IVisualizerObjectProvider objectProvider);
        ...
        protected override void Show(IDialogVisualizerService windowService, IVisualizerObjectProvider objectProvider)
        {
            ...
            try
            {
                IGeometry geometry = GetObject(objectProvider);

                _spatialViewerControl.SetGeometry(new IGeometryStyled(geometry, Color.FromArgb(200, 0, 175, 0), Colors.Black, 1f, null, true));
